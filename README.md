...
Le démarreur CSS contient des composants et des modèles pour créer une interface utilisateur pure CSS.
...
Comme vos styles diffèrent des styles de démarrage, modifiez les styles plutôt que de les surcharger.
